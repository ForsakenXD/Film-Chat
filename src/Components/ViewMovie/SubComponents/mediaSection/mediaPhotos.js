...
function MediaPhotos(props){
    return(
        <figure className="imghvr-blur" style={{backgroundColor: 'transparent',cursor:'pointer'}} key={props.key} onClick={() => window.open(`https://image.tmdb.org/t/p/original/${props.image.file_path}`)}>
