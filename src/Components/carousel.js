    ...
    return (
      <Carousel activeIndex={index} direction={direction} onSelect={handleSelect} style={{width:'100%'}}>
        ...
        <div style={{display:'flex'}}>
            <CarouselItem triggerModal={props.triggerModal} show={props.show} id={11104} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/9UkQyYKvqFZyEo9ztLBx0yPEQwS.jpg"} name={'Chunking Express'} rating={"8.1/10"} releaseDate={1994} zIndex={10} description={"Two melancholy Hong Kong policemen fall in love: one with a mysterious female underworld figure, the other with a beautiful and ethereal server at a late-night restaurant he frequents."}/>
