    ...
    return (
      <Carousel activeIndex={index} direction={direction} onSelect={handleSelect} style={{width:'100%'}}>
        ...
        <div style={{display:'flex'}}>
            <CarouselItem show={props.show} id={11104} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/9UkQyYKvqFZyEo9ztLBx0yPEQwS.jpg"} name={'Chunking Express'} rating={"8.1/10"} releaseDate={1994} zIndex={10} description={"Two melancholy Hong Kong policemen fall in love: one with a mysterious female underworld figure, the other with a beautiful and ethereal server at a late-night restaurant he frequents."}/>
            <CarouselItem show={props.show} id={'11220-duo-luo-tian-shi'} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/aqCpkOvZ7hNdTT70sSnGSRxmYxv.jpg"} name={"Fallen Angels"} rating={"8/10"} releaseDate={1995} description={"In this bifurcated crime narrative, a disillusioned hitman attempts to escape from his violent lifestyle against the wishes of his partner, who is infatuated with him, and an eccentric mute repeatedly encounters, then subsequently falls for, a depressed woman looking for the prostitute who supposedly stole her ex-boyfriend’s affections."}/>
            <CarouselItem show={props.show} id={15804} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/3l8fOAwiN3N5n3hHnZ51eog7Zu2.jpg"} name={"A brighter summer day"} rating={"8/10"} releaseDate={1994} description={"A boy experiences first love, friendships and injustices growing up in 1960s Taiwan."} />
          </div>
        ...
        <div style={{display:'flex'}}>
            <CarouselItem show={props.show} id={18491} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/5JYzfyKBwReaQ41WFhqXgOZnPWV.jpg"} zIndex={10} name={'Neon Genesis Evangelion:The End of Evangelion'} rating={"8.6/10"} releaseDate={1997} description={"The second of two theatrically released follow-ups to the Neon Genesis Evangelion series. Comprising of two alternate episodes which were first intended to take the place of episodes 25 and 26, this finale answers many of the questions surrounding the series, while also opening up some new possibilities."}/>
            <CarouselItem show={props.show} id={'149-akira'} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/ylkqgfgZ6wtGztvvXR9CbdJNzcX.jpg"} name={"Akira"} rating={"8.2/10"} releaseDate={1988} description={"NEO-TOKYO IS ABOUT TO E.X.P.L.O.D.E.A secret military project endangers Neo-Tokyo when it turns a biker gang member into a rampaging psychic psychopath that only two teenagers and a group of psychics can stop."}/>
            <CarouselItem show={props.show} id={'9323-ghost-in-the-shell'} roomName={props.roomName} image={"https://image.tmdb.org/t/p/original/a4EPetwSkXI1dg9wF5agbnkuisc.jpg"} name={"Ghost in the shell"} rating={"7.8/10"} releaseDate={1995} color={'black'} description={'In the year 2029, the barriers of our world have been broken down by the net and by cybernetics, but this brings new vulnerability to humans in the form of brain-hacking. When a highly-wanted hacker known as ‘The Puppetmaster’ begins involving them in politics, Section 9, a group of cybernetically enhanced cops, are called in to investigate and stop the Puppetmaster.'}/>
          </div>
