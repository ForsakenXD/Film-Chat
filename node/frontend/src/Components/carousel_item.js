        ...
        <figure className="imghvr-blur " style={{backgroundColor: 'transparent',width:'30%',zIndex:props.zIndex,marginRight:'1em'}} >
          <img
            ...
            <figcaption style={gradient} className="hovers">
              <h3  className="ih-fade-down ih-delay-sm carousel-into" style={{fontSize:'2rem',position:'relative'}}>{props.name}</h3>
                  ...
                  <h5 className="carousel-desc" style={{position:'relative'}} >{props.description}</h5>
                  <h5 className="carousel-into"  style={{position:'relative'}}>Release Date:{props.releaseDate}</h5>
                  <h5 className="carousel-into"  style={{position:'relative'}} >Rating:{props.rating}</h5>
            </figcaption>
          </figure>
